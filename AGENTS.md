...
It fails on unresolved template placeholders, `TBD`, missing or reordered template sections, empty section bodies, missing Operator Interface subsections, missing ATen/Python/C++ signature code blocks, framework-dependent C++ namespace types, missing Python docstring or C++ Doxygen parameter documentation, and unresolved open issues.
